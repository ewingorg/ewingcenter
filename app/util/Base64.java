...
public class Base64 {
    ...
    /**
     * Encodes or decodes two files from the command line; <strong>feel free to delete this method (in fact you probably should) if you're
     * embedding this code into a larger program.</strong>
     */
    ...
    /**
     * Very low-level access to decoding ASCII characters in the form of a byte array. Does not support automatically gunzipping or any
    ...
    /**
     * yahoo y64 encode for encoded url replace tar '=' to '-' replace tar '+' to '.' replace tar '/' to '_'
     * 
     * @param src String
     * @return tar String
     * @author afei 2007-8-8
    ...
    /**
     * yahoo y64 decode for encoded url replace tar '-' to '=' replace tar '.' to '+' replace tar '_' to '/'
     * 
     * @param src String
     * @return tar String
     * @author afei 2007-8-8
